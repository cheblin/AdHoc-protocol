...
**BlackBox** support bitfields, any primitive datatypes, single/double bytes char strings and any variations of it's multidimensional arrays with static and variable dimensions.<br>
